...
iex(6)> orders
+--------+---------+--------+------+-------+--------+-----------+-----+------------+----------------+---------------+--------+-----------+----------------+----------------+------------------+--------------+
|  Venue | Account | Symbol | Side |  Type |  Price | Avg Price | Qty | Leaves Qty | Cumulative Qty | Time in Force | Status | Client ID | Venue Order ID |    Enqueued At | Venue Created At | Error Reason |
+--------+---------+--------+------+-------+--------+-----------+-----+------------+----------------+---------------+--------+-----------+----------------+----------------+------------------+--------------+
