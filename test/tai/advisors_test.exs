defmodule Tai.AdvisorsTest do
  ...
  describe ".specs" do
    ...
    test "returns a list of advisor specs generated by the factory" do
      assert [advisor | []] = Tai.Advisors.specs(@config, [], TestProvider)
    ...
    test "can apply filters" do
      ...
      assert Tai.Advisors.specs(@config, [advisor_id: :your_advisor], TestProvider) == []
      assert Tai.Advisors.specs(@config, [start_on_boot: true], TestProvider) == []
      assert Tai.Advisors.specs(@config, [group_id: :group_b], TestProvider) == []
    end
  end
