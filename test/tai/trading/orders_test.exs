defmodule Tai.Trading.OrdersTest do
  ...
  test "count returns the total number of orders" do
    ...
    Orders.add(OrderSubmission.buy_limit(:my_test_account, :btcusd, 100.0, 1.0))
  ...
  test "add can take a single submission" do
    ...
    [order] = Orders.add(OrderSubmission.buy_limit(:my_test_account, :btcusd, 100.0, 1.0))
  ...
  test "add can take multiple submissions" do
    ...
    [order_1, order_2] =
      Orders.add([
        OrderSubmission.buy_limit(:my_test_account, :btcusd, 100.0, 1.0),
        OrderSubmission.sell_limit(:my_test_account, :ltcusd, 10.0, 1.1)
      ])
  ...
  test "where can filter by a singular client_id" do
    [_order_1, order_2, _order_3] =
      Orders.add([
        OrderSubmission.buy_limit(:my_test_account, :btcusd, 100.0, 0.1),
        OrderSubmission.buy_limit(:my_test_account, :btcusd, 100.0, 1.0),
        OrderSubmission.buy_limit(:my_test_account, :btcusd, 100.0, 2.0)
      ])
