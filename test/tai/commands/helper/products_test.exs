defmodule Tai.Commands.Helper.ProductsTest do
  ...
  test "show products and their trade restrictions for configured exchanges" do
    ...
    assert capture_io(&Tai.Commands.Helper.products/0) == """
           +-----------------+---------+--------------+---------+--------+-----------+-----------+-----------+-----------+-----------------+----------+----------+----------------+--------------+
           |           Venue |  Symbol | Venue Symbol |  Status | Margin | Maker Fee | Taker Fee | Min Price | Max Price | Price Increment | Min Size | Max Size | Size Increment | Min Notional |
           +-----------------+---------+--------------+---------+--------+-----------+-----------+-----------+-----------+-----------------+----------+----------+----------------+--------------+
           | test_exchange_a | btc_usd |      BTC_USD | trading |  false |      0.1% |      0.2% |   0.00001 |    100000 |        0.000001 |    0.001 |   100000 |          0.001 |         0.01 |
           | test_exchange_b | eth_usd |      ETH_USD | trading |   true |           |           |   0.00001 |    100000 |        0.000001 |    0.001 |          |          0.001 |         0.01 |
           +-----------------+---------+--------------+---------+--------+-----------+-----------+-----------+-----------+-----------------+----------+----------+----------------+--------------+\n
           """
  end
