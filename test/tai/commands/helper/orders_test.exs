defmodule Tai.Commands.Helper.OrdersTest do
  ...
  test "shows items in ascending order from when they were enqueued" do
    ...
    assert capture_io(&Tai.Commands.Helper.orders/0) == """
           +-----------------+---------+---------+------+-------+----------+-----------+-----+------------+----------------+---------------+----------+-----------+----------------+-------------+------------------+------------+------------------+--------------+
           |           Venue | Account |  Symbol | Side |  Type |    Price | Avg Price | Qty | Leaves Qty | Cumulative Qty | Time in Force |   Status | Client ID | Venue Order ID | Enqueued At | Venue Created At | Updated At | Venue Updated At | Error Reason |
           +-----------------+---------+---------+------+-------+----------+-----------+-----+------------+----------------+---------------+----------+-----------+----------------+-------------+------------------+------------+------------------+--------------+
