defmodule Tai.Commands.Helper.OrdersTest do
  ...
  test "shows items in ascending order from when they were enqueued" do
    ...
    assert capture_io(&Tai.Commands.Helper.orders/0) == """
           +-----------------+---------+---------+------+-------+----------+-----+----------------+---------------+----------+--------------------------------------+----------------+-------------+------------+--------------+
           |        Exchange | Account |  Symbol | Side |  Type |    Price | Qty | Cumulative Qty | Time in Force |   Status |                            Client ID | Venue Order ID | Enqueued At | Created At | Error Reason |
           +-----------------+---------+---------+------+-------+----------+-----+----------------+---------------+----------+--------------------------------------+----------------+-------------+------------+--------------+
           | test_exchange_a |    main | btc_usd |  buy | limit | 12999.99 | 1.1 |              0 |           fok | enqueued | #{
             btc_usd_order.client_id
           } |                |         now |            |              |
           | test_exchange_b |    main | ltc_usd | sell | limit |    75.23 | 1.0 |              0 |           fok | enqueued | #{
