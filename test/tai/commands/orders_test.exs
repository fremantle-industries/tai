defmodule Tai.Commands.OrdersTest do
  ...
  test "shows items in ascending order from when they were enqueued" do
    ...
    assert capture_io(&Tai.CommandsHelper.orders/0) == """
           ...
           +-----------------+---------+----------------+--------------+------+-------+----------+-----------+-----+------------+----------------+---------------+----------+-----------+----------------+-------------+------------------+----------------------+------------+--------------+
           | test_exchange_a |    main |        btc_usd |         spot |  buy | limit | 12999.99 |         0 | 1.1 |        1.1 |              0 |           fok | enqueued | #{
             btc_usd_order_client_id
           } |                |         now |                  |                      |            |              |
           | test_exchange_b |    main |        ltc_usd |         spot | sell | limit |    75.23 |         0 | 1.0 |        1.0 |              0 |           fok | enqueued | #{
