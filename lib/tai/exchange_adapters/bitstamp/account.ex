defmodule Tai.ExchangeAdapters.Bitstamp.Account do
  @moduledoc """
  Execute private exchange actions for the Bitstamp account
  """

  use GenServer

  alias Tai.Exchanges.Account
  alias Tai.ExchangeAdapters.Bitstamp.Account.{Balance, CancelOrder, Orders, OrderStatus}
