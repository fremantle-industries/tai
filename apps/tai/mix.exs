defmodule Tai.Mixfile do
  ...
  defp deps do
    [
      ...
      {:ecto, "~> 3.6"},
      {:ecto_sql, "~> 3.6"},
      {:ecto_sqlite3, "~> 0.5.6", optional: true},
      # {:ecto_term, github: "fremantle-industries/ecto_term"},
      {:ecto_term, "~> 0.0.1"},
      {:enumerati, "~> 0.0.8"},
      {:ex2ms, "~> 1.0"},
      {:ex_binance, "~> 0.0.8"},
      # {:ex_bitmex, github: "fremantle-capital/ex_bitmex", branch: "main"},
      {:ex_bitmex, "~> 0.6.1"},
      # {:ex_deribit, github: "fremantle-capital/ex_deribit", branch: "main"},
      {:ex_deribit, "~> 0.0.9"},
      # {:ex_ftx, github: "fremantle-capital/ex_ftx", branch: "main"},
      {:ex_ftx, "~> 0.0.13"},
      # {:ex_okex, github: "fremantle-capital/ex_okex", branch: "main"},
      {:ex_okex, "~> 0.6"},
      {:ex_gdax, "~> 0.2"},
      # {:ex_huobi, github: "fremantle-capital/ex_huobi", branch: "main"},
      {:ex_huobi, "~> 0.0.2"},
      {:decimal, "~> 2.0"},
      {:httpoison, "~> 1.0"},
      {:jason, "~> 1.1"},
      ...
      # {:polymorphic_embed, github: "rupurt/polymorphic_embed", branch: "load-map-field-string"},
      {:polymorphic_embed, github: "mathieuprog/polymorphic_embed", branch: "master"},
      {:poolboy, "~> 1.5.1"},
      {:postgrex, "~> 0.15", optional: true},
      {:myxql, "~> 0.5.0", optional: true},
      {:table_rex, "~> 3.0"},
