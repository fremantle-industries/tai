defmodule Tai.IEx do
  ...
  @spec help :: no_return
  defdelegate help, to: Tai.IEx.Commands.Help

  @spec accounts :: no_return
  defdelegate accounts, to: Tai.IEx.Commands.Accounts

  @spec products :: no_return
  defdelegate products, to: Tai.IEx.Commands.Products

  @spec fees :: no_return
  defdelegate fees, to: Tai.IEx.Commands.Fees

  @spec markets :: no_return
  defdelegate markets, to: Tai.IEx.Commands.Markets

  @spec positions :: no_return
  defdelegate positions, to: Tai.IEx.Commands.Positions

  @spec orders :: no_return
  defdelegate orders, to: Tai.IEx.Commands.Orders

  @spec venues() :: no_return
  @spec venues(list) :: no_return
  defdelegate venues(args \\ []), to: Tai.IEx.Commands.Venues, as: :list
  ...
  defdelegate start_venue(venue, store_id \\ Tai.Venues.VenueStore.default_store_id()),
    to: Tai.IEx.Commands.StartVenue,
    as: :start
  ...
  defdelegate stop_venue(venue, store_id \\ Tai.Venues.VenueStore.default_store_id()),
    to: Tai.IEx.Commands.StopVenue,
    as: :stop

  @spec advisors() :: no_return
  @spec advisors(list) :: no_return
  defdelegate advisors(args \\ []), to: Tai.IEx.Commands.Advisors, as: :list

  @spec start_advisors() :: no_return
  @spec start_advisors(list) :: no_return
  defdelegate start_advisors(args \\ []), to: Tai.IEx.Commands.Advisors, as: :start

  @spec stop_advisors() :: no_return
  @spec stop_advisors(list) :: no_return
  defdelegate stop_advisors(args \\ []), to: Tai.IEx.Commands.Advisors, as: :stop

  @spec settings :: no_return
  defdelegate settings, to: Tai.IEx.Commands.Settings

  @spec enable_send_orders :: no_return
  defdelegate enable_send_orders, to: Tai.IEx.Commands.SendOrders, as: :enable

  @spec disable_send_orders :: no_return
  defdelegate disable_send_orders, to: Tai.IEx.Commands.SendOrders, as: :disable
end
