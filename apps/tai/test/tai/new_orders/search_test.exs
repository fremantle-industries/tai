defmodule Tai.NewOrders.SearchTest do
  ...
  test "can paginate results with a custom page & size" do
    ...
    search_orders_1 = Tai.NewOrders.search(nil, page: 1, page_size: 2)
    ...
    search_orders_2 = Tai.NewOrders.search(nil, page: 2, page_size: 2)
  ...
  test "can filter results with a search term" do
    ...
    search_orders = Tai.NewOrders.search("venue_a")
