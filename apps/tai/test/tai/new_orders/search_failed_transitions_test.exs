defmodule Tai.NewOrders.SearchFailedTransitionsTest do
  ...
  test "returns the oldest 25 failed order transitions by default" do
    ...
    search_failed_order_transitions = Tai.NewOrders.search_failed_transitions(order.client_id, nil)
  ...
  test "can paginate results with a custom page & size" do
    ...
    search_failed_order_transitions_1 = Tai.NewOrders.search_failed_transitions(order.client_id, nil, page: 1, page_size: 2)
    ...
    search_failed_order_transitions_2 = Tai.NewOrders.search_failed_transitions(order.client_id, nil, page: 2, page_size: 2)
