defmodule Tai.NewOrders.Transitions.AcceptCreateTest do
  ...
  test ".attrs/1 returns a list of updatable order attributes" do
    ...
    transition = %Transitions.AcceptCreate{venue_order_id: "abc123", last_received_at: last_received_at, last_venue_timestamp: last_venue_timestamp}
