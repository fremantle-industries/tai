defmodule Tai.NewOrders.Transitions.AcceptAmendTest do
  ...
  test ".attrs/1 returns a list of updatable order attributes" do
    ...
    transition = %Transitions.AcceptAmend{last_received_at: last_received_at, last_venue_timestamp: last_venue_timestamp}
