defmodule Tai.NewOrders.SearchTransitionsTest do
  ...
  test "returns the oldest 25 order transitions by default" do
    ...
    search_order_transitions = Tai.NewOrders.search_transitions(order.client_id, nil)
  ...
  test "can paginate results with a custom page & size" do
    ...
    search_order_transitions_1 = Tai.NewOrders.search_transitions(order.client_id, nil, page: 1, page_size: 2)
    ...
    search_order_transitions_2 = Tai.NewOrders.search_transitions(order.client_id, nil, page: 2, page_size: 2)
