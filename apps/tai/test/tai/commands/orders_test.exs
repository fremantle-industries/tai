defmodule Tai.Commands.OrdersTest do
  ...
  test "shows items in ascending order from when they were enqueued" do
    ...
    assert capture_io(&Tai.CommandsHelper.orders/0) == """
           +-----------------+---------+----------------+--------------+------+-------+----------+-----+------------+----------------+---------------+----------+-----------+----------------+-------------+------------------+----------------------+------------+--------------+
           |           Venue | Account | Product Symbol | Product Type | Side |  Type |    Price | Qty | Leaves Qty | Cumulative Qty | Time in Force |   Status | Client ID | Venue Order ID | Enqueued At | Last Received At | Last Venue Timestamp | Updated At | Error Reason |
           +-----------------+---------+----------------+--------------+------+-------+----------+-----+------------+----------------+---------------+----------+-----------+----------------+-------------+------------------+----------------------+------------+--------------+
