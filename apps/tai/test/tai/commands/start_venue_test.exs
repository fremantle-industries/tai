defmodule Tai.Commands.StartVenueTest do
  ...
  test "shows a message that the venue is starting" do
    ...
    assert capture_io(fn -> Tai.CommandsHelper.start_venue(@venue) end) == """
           starting...
           """
  ...
  test "shows an error when the venue doesn't exist" do
    ...
    assert capture_io(fn -> Tai.CommandsHelper.start_venue(:i_dont_exist) end) ==
             """
